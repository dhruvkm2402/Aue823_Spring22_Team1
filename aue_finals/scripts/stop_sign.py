...
class stopsign:
    ...
    def newprediction(self,bounding_box):
        ...
        for box in prediction:
            ...
            if (identified_class == 'stop sign'):        #change based on the calibration
                stop_sign_detect = 1
...
while True:
    ...
    if line_detection ==1:
        ...
        launch = roslaunch.parent.ROSLaunchParent(uuid,["/home/adhitir/catkin_ws/src/darknet_ros/darknet_ros/launch/darknet_ros.launch"])
        launch.start()
